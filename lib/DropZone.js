...
class DropZone extends React.Component {
    ...
    render() {
      const { style, ...rest } = this.props
        ...
        return <View style={style} pointerEvents={this.props.pointerEvents} onLayout={this.reportMeasurements} ref="wrapper">
          {
            React.Children.map(this.props.children, child => {
              return React.cloneElement(child, Object.assign({}, rest, {dragOver: this.state.active}));
            })
          }
        </View>;
    }
