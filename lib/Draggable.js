...
class Draggable extends React.Component {
    ...
    render() {
        ...
        return <TouchableOpacity disabled={this.props.disabled} activeOpacity={this.props.activeOpacity} style={this.props.style} onLongPress={this.props.dragOn === 'onLongPress' ? this._initiateDrag : undefined} onPress={this.props.dragOn === 'onPressIn' ? this._initiateDrag : undefined} ref="wrapper">
        {
